...
export const allStationDict: { [key: string]: Omit<Station, 'sell_price_list' | 'buy_price_list'>} = {
  ...
  83000012: createStation(
    "83000012", 
    "station", 
    { cn: "阿妮塔战备工厂", en: "Anita Weapon Reasearch Institute" },
    {84701167: 1000, 84701169:1000, 84701168: 1000, 84701170: 1000, 84701536:1000, 84701171: 1000, 84701163:1000, 84701173:1000, 84701174:1000},
    0
  ),
...
export const getStationGoods = (station_id: string) => Object.entries(allStationDict[station_id].goodsList)
...
export const getStock = (station_id: string, good_id: string) => {
  return allStationDict[station_id].goodsList[good_id]
}

export const getStationId = (name: string) => {
  return filteredStationDict.find(([station_id, station]) => station.name.cn === name)?.[0]
}