const createStation = (station_id: string, type: string, name: I18string, goods_list: { [key: string]: number }): Omit<Station, 'sell_price_list' | 'buy_price_list'> => {
  return {
    station_id,
    type,
    name,
...
export const allStationDict: { [key: string]: Omit<Station, 'sell_price_list' | 'buy_price_list'>} = {
  ...
  83000003: createStation(
    ...
    {84700624: 25, 84700232: 32, 84700675: 36, 84700615: 55, 84700408: 70, 84700135: 101}
  ),
